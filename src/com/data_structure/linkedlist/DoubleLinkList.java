...
public class DoubleLinkList {
    public static void main(String[] args) {
        ...
        doubleLinkedList2.init(x5);
        doubleLinkedList2.add(x3);
        doubleLinkedList2.add(x1);
        doubleLinkedList2.add(x4);
        doubleLinkedList2.add(x2);
//        // 添加节点
        doubleLinkedList.init(h3); // 载入表头
        doubleLinkedList.add(h5); // 向链表后方插入数据
        doubleLinkedList.add(h2); // 向链表后方插入数据
        doubleLinkedList.add(h4); // 向链表后方插入数据
...
//        System.out.println(doubleLinkedList.getHead().next);
//        doubleLinkedList2.list();
//
//        System.out.println("head2==========");
//        System.out.println(doubleLinkedList2.getHead().next);
//        System.out.println("=========合并后");
//        HeroesNode heroesNode = doubleLinkedList.mergeLinkedList(doubleLinkedList.getHead(), doubleLinkedList2.getHead());
...
//        }
        ...
        // 更新节点
        //doubleLinkedList.updateNode(5, "士元");

        // 删除节点
        //doubleLinkedList.removeNode(3);
        //System.out.println("================111111111111");
        //doubleLinkedList.list();
        //System.out.println("当前链表个数:" + doubleLinkedList.count());
        // doubleLinkedList.findReverseNum(1);
