...
public class Play {
    public static void main(String[] args) {
        ...
        singleLinkedList2.init(h1);
        singleLinkedList2.add(h3);
        singleLinkedList2.add(h4);
        singleLinkedList2.add(x1);
        singleLinkedList2.add(x4);
//        // 添加节点
        singleLinkedList.init(h2); // 载入表头
        singleLinkedList.add(h5); // 向链表后方插入数据
        singleLinkedList.add(x2); // 向链表后方插入数据
        singleLinkedList.add(x3); // 向链表后方插入数据
        singleLinkedList.add(x5);
